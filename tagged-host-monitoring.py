...
url1 = "https://<YOUR_DYNATRACE_ENVIRONMENT>.live.dynatrace.com/api/v2/entities" # Change the placeholder with your Dynatrace environment
params = {
    "entitySelector": "type(host), tag(\"<YOUR_TAG_VALUE>\")" # Change the placeholder with your tag value
}
headers = {
...
for host_id in host_ids:
    url2 = "https://<YOUR_DYNATRACE_ENVIRONMENT>.live.dynatrace.co/api/v2/settings/objects" # Change the placeholder with your Dynatrace environment
    params = {
